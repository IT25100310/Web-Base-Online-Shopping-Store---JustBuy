            ...
            <section class="checkout-card glass-lg">
              ...
              <div class="form-grid">
                <div class="form-field full">
                  ...
                  <input type="text" id="ship-name" value="${user.name}" class="form-input glass" required />
                </div>

                <div class="form-field half">
                  <label>Email Address (For Tracking & Invoice)</label>
                  <input type="email" id="ship-email" value="${user.email}" class="form-input glass" required />
                </div>
                ...
                <div class="form-field full">
                  ...
                  <input type="text" id="ship-address" value="${user.address}" class="form-input glass" required />
                </div>
              ...
              <div class="liquid-credit-card glass">
                ...
                <div class="card-meta-row">
                  <div>
                    ...
                    <span class="card-holder-name" id="cc-name-preview">${user.name}</span>
                  </div>
                  <div>
  ...
  afterRender() {
    ...
    if (placeBtn) {
      placeBtn.addEventListener('click', async () => {
        ...
        const totals = Store.getCartTotals();
        const orderData = {
          customerName: document.getElementById('ship-name')?.value || 'Alexander Wright',
          customerEmail: document.getElementById('ship-email')?.value || 'alex@justbuy.design',
          shippingAddress: document.getElementById('ship-address')?.value || '742 Evergreen Terrace, NY',
        ...
        Store.clearCart();
        window.location.hash = `#/order-success/${result.id || 1001}`;
      });
    }
  }
};
