...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedCategories() {
        List<Category> cats = List.of(
                Category.builder()
                        ...
                        .slug("electronics")
                        .icon("⚡")
                        .imageUrl(IMG + "electronics/600/400")
                        .color("#F26B1D")
                        .featured(true)
                        .productCount(1240)
                ...
                Category.builder()
                        ...
                        .slug("sports")
                        .icon("🏃")
                        .imageUrl(IMG + "sports/600/400")
                        .color("#6B7B5C")
                        .featured(true)
                        .productCount(760)
                        .description("Fitness, outdoor & activewear")
                        .build(),
                ...
                Category.builder()
                        ...
                        .slug("books")
                        .icon("📚")
                        .imageUrl(IMG + "book/600/400")
                        .color("#7B6F8A")
                        .featured(false)
                        .productCount(4200)
                        .description("Books, stationery & art supplies")
                        .build(),
        ...
        /*
         * Insert only categories whose slug does not already exist.
         * This prevents duplicate-category errors when the application
         * starts more than once.
         */
        List<Category> newCategories = cats.stream()
                .filter(category ->
                        categoryRepo.findBySlug(category.getSlug()).isEmpty()
                )
                .toList();

        if (!newCategories.isEmpty()) {
            categoryRepo.saveAll(newCategories);
            log.info("{} new categories inserted.", newCategories.size());
        } else {
            log.info("Categories already exist. Nothing to insert.");
        }
    }
    ...
    private void seedSellers() {
        List<Seller> sellers = List.of(
                Seller.builder()
                        .name("TechNova Store")
                        .email("seller@justbuy.com")
                        .passwordHash(passwordEncoder.encode("seller123"))
                        .slug("technova")
                        .description("Premium electronics & gadgets curated for the modern lifestyle.")
                        .logoUrl(IMG + "technova/80/80")
                        .bannerUrl(IMG + "techbanner/1200/300")
                        .rating(4.8)
                        .reviewCount(12400)
                        .followerCount(98200)
                        .salesCount(245000)
                ...
                Seller.builder()
                        .name("Linen & Lace")
                        .email("linen@justbuy.com")
                        .slug("linen-lace")
                        .description("Minimalist fashion for the mindful wardrobe.")
                        .logoUrl(IMG + "linen/80/80")
                        .bannerUrl(IMG + "fashionbanner/1200/300")
                        .rating(4.9)
                        .reviewCount(8700)
                        .followerCount(62000)
                        .salesCount(134000)
                ...
                Seller.builder()
                        .name("Casa Moderna")
                        .email("casa@justbuy.com")
                        .slug("casa-moderna")
                        .description("Scandinavian-inspired home décor & living essentials.")
                        .logoUrl(IMG + "casa/80/80")
                        .bannerUrl(IMG + "homebanner/1200/300")
                        .rating(4.7)
                        .reviewCount(5200)
                        .followerCount(41000)
                        .salesCount(89000)
                ...
                Seller.builder()
                        .name("Glow Lab")
                        .email("glow@justbuy.com")
                        .slug("glow-lab")
                        .description("Clean beauty, natural skincare, dermatologist-tested formulas.")
                        .logoUrl(IMG + "glow/80/80")
                        .bannerUrl(IMG + "beautybanner/1200/300")
                        .rating(4.9)
                        .reviewCount(9800)
                        .followerCount(75000)
                        .salesCount(198000)
                ...
                Seller.builder()
                        .name("Peak Sports")
                        .email("peak@justbuy.com")
                        .slug("peak-sports")
                        .description("Performance sportswear & outdoor gear for every athlete.")
                        .logoUrl(IMG + "peak/80/80")
                        .bannerUrl(IMG + "sportsbanner/1200/300")
                        .rating(4.6)
                        .reviewCount(3100)
                        .followerCount(28000)
                        .salesCount(56000)
        ...
        List<Seller> newSellers = sellers.stream()
                .filter(seller ->
                        sellerRepo.findBySlug(seller.getSlug()).isEmpty()
                )
                .toList();

        if (!newSellers.isEmpty()) {
            sellerRepo.saveAll(newSellers);
            log.info("{} new sellers inserted.", newSellers.size());
        } else {
            log.info("Sellers already exist. Nothing to insert.");
        }
    }
